...
오픈 소스들을 빠르게 흡수해서 AWS 서비스로 빠르게 접목해 나가는 부분이 한편으로는 무섭기도 했다.

https://www.slideshare.net/awskorea/elasticsearch-fulltext-aws-aws-summit-seoul-2019

## 후 평
볼거리가 매우 많아졌다는 부분이 매우 좋았다. 한편으로는 듣고 싶었던 세션들이 겹쳐서 참석 못한 부분도 있다. (CI/CD ...)
그리고 많은 업채들이 다양한 정보를 공유하고 있으니 중간 중간 시간이 빌 때는 EXPO에 참석하면 되니 지루할 틈이 없었다.
한편으로 아쉬웠던 부분은 강의장이 적었던 곳은 불의 세기 때문에 PPT가 잘 보이지 않았다.
